...
<div class="main-header">
    ...
    <p>Tác giả: Dương Thị Phương - Trường Tiểu học Vĩnh Hảo - ĐT: 0917 105 745</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Dương Thị Phương - Trường Tiểu học Vĩnh Hảo - ĐT: 0917 105 745</div>", unsafe_allow_html=True)
